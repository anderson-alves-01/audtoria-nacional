# Matriz técnica ROADMAP 1.2 versus código (pós-0.3.11)
...
| F3.1 ingestão sintética genérica | F3.0 | feito 0.3.11 (IBGE) | `evidence/releases/0.3.11/` | `test_source_ingest` | LOCAL_GO | dado real / SIDRA oficial | Tesouro stub 0.3.12 |
...
| G0/G1 checklists | — | ausente | — | API blocked | BLOCKED | decisão humana | contratos/flags UI |
...
DAG: `0.3.11 IBGE F3.1 → 0.3.12 Tesouro stub + G0/G1 UI → terraform modules no-apply`. Parar em G0/G1/G4/G7 oficial/G8 oficial/G9/G10.
