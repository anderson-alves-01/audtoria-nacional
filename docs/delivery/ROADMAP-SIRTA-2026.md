...
A implementação `0.3.49` ativa a quota-parte de ICMS de Goiás (XLSX Secretaria da Economia) e mantém IPVA GO via DataStore, ICMS Verde do Pará, ICMS/IPVA do Paraná e demais UFs já aprovadas. Gold permanece `REAL_OFFICIAL_DATA_PENDING_HUMAN_VALIDATION`. O Programa SIRTA 2026 **não** está concluído. Pacote: `docs/delivery/HUMAN_VALIDATION_PACKAGE.md`.
