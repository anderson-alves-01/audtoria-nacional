...
A implementação `0.3.97` ativa BCB OLINDA `ExpectativasMercadoInflacao12Meses`
e `ExpectativasMercadoInflacao24Meses` (FOCUS_INFLACAO_12M/24M, horizonte
`Suavizada`, silverCount 8 cada); mantém Selic Copom, SC Anual_2017, BCB
OLINDA anuais/mensais/trimestrais, pacote COINT municipal e demais ativações
estaduais/setoriais anteriores.
