...
| Versão da implementação local | `0.3.50` |
...
A implementação `0.3.50` ativa IPI e CIDE do Espírito Santo e IPI-Exportação de Goiás nos mesmos arquivos PUBLIC_OPEN já usados para ICMS/IPVA, e mantém as demais UFs já aprovadas. Gold permanece `REAL_OFFICIAL_DATA_PENDING_HUMAN_VALIDATION`. O Programa SIRTA 2026 **não** está concluído. Pacote: `docs/delivery/HUMAN_VALIDATION_PACKAGE.md`.
