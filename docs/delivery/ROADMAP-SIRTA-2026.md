...
A implementação `0.3.75` expande BCB OLINDA Expectativas Focus
(IPCA+Selic+Câmbio+PIB Total+PIB Serviços+PIB Agropecuária+PIB Indústria+IGP-M+IGP-DI+INPC+Dívida líquida do setor público+Dívida bruta do governo geral+Balança comercial Saldo+Resultado primário+Conta corrente+Resultado nominal+Taxa de desocupação) além do SGS 432/433;
