...
A implementação `0.3.72` expande BCB OLINDA Expectativas Focus
(IPCA+Selic+Câmbio+PIB Total+PIB Serviços+PIB Agropecuária+PIB Indústria+IGP-M+IGP-DI+INPC+Dívida líquida do setor público+Balança comercial Saldo+Resultado primário+Conta corrente) além do SGS 432/433;
