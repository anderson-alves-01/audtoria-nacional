...
A implementação `0.3.69` expande BCB OLINDA Expectativas Focus
(IPCA+Selic+Câmbio+PIB Total+PIB Serviços+IGP-M+IGP-DI+INPC) além do SGS 432/433;
