"""One-shot probe for BCB OLINDA Dívida bruta do governo geral."""
...
def main() -> None:
    ...
    # Mirror Dívida líquida: baseCalculo=0 (PERCENT_OF_GDP)
    fetch(
        "divida-bruta",
        build_url(indicator="Dívida bruta do governo geral", base_calculo=0),
    )
