"""Probe BCB OLINDA for PIB Despesa de consumo da administração pública."""
...
INDICATOR = "PIB Despesa de consumo da administração pública"
...
PROBE = Path(__file__).with_name(
    "bcb-olinda-expectativas-pib-despesa-adm-publica-anuais-top8-probe.json"
)
