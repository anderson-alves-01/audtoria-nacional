"""Probe BCB OLINDA for PIB Importação de bens e serviços."""
...
INDICATOR = "PIB Importação de bens e serviços"
...
PROBE = Path(__file__).with_name(
    "bcb-olinda-expectativas-pib-importacao-bens-servicos-anuais-top8-probe.json"
)
