"""Probe BCB OLINDA for PIB Exportação de bens e serviços."""
...
INDICATOR = "PIB Exportação de bens e serviços"
...
PROBE = Path(__file__).with_name(
    "bcb-olinda-expectativas-pib-exportacao-bens-servicos-anuais-top8-probe.json"
)
