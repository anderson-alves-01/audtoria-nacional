"""One-shot probe for BCB OLINDA Investimento direto no pais."""
...
def fetch(name: str, url: str) -> dict:
    print(name, url)
    req = urllib.request.Request(url, headers={"User-Agent": "sirta-probe/0.3.76"})
...
def main() -> None:
    ...
    indicator = "Investimento direto no pa" + "\u00eds"
    fetch(
        "investimento-direto",
