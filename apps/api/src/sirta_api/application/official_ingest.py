...
def _bcb_olinda_expectativas_url(
    *,
    ...
    horizon = str(horizon_field or "DataReferencia").strip() or "DataReferencia"
    ...
    return (
        ...
        f"$orderby=Data%20desc,{horizon}%20asc&"
        f"$select={select}"
    )
...
def _parse_bcb_olinda_expectativas_allowlist(
    ...
    *,
    ...
    horizon_field = str(parameters.get("horizon_field") or "DataReferencia").strip() or (
        "DataReferencia"
    )
