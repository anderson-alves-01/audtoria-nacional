"""State ICMS/IPVA transfer catalog shell. No tax credit; PE/BA/MG ingest gated."""
...
DISCLAIMER = (
    "Catálogo estadual ICMS/IPVA. PE, BA e MG ativados com CSV PUBLIC_OPEN "
    "(MG com IBGE7 nativo). "
...
def reject_state_transfers_command() -> None:
    raise ConflictError(
        ...
        "catalogada por fonte (PE/BA/MG ICMS/IPVA) quando TECHNICALLY_APPROVED; sem crédito."
    )
