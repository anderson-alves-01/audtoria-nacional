# Conteúdo do kit e da implementação 0.3.77
...
- `docs/delivery/RELEASE_NOTES_0.3.77.md`: notas desta fatia (BCB OLINDA IPCA Livres + IPCA Serviços).
...
- `evidence/releases/0.3.77/`: evidências desta fatia.
