# Conteúdo do kit e da implementação 0.3.81
...
- `docs/delivery/RELEASE_NOTES_0.3.81.md`: notas desta fatia (BCB OLINDA PIB Despesa de consumo das famílias).
...
- `evidence/releases/0.3.81/`: evidências desta fatia.
