# Conteúdo do kit e da implementação 0.3.93
...
- `docs/delivery/RELEASE_NOTES_0.3.93.md`: notas desta fatia (BCB OLINDA Expectativas trimestrais).
...
- `evidence/releases/0.3.93/`: evidências desta fatia.
