# Conteúdo do kit e da implementação 0.3.78
...
- `docs/delivery/RELEASE_NOTES_0.3.78.md`: notas desta fatia (BCB OLINDA IPCA Administrados + Alimentação).
...
- `evidence/releases/0.3.78/`: evidências desta fatia.
