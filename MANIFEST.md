# Conteúdo do kit e da implementação 0.3.83
...
- `docs/delivery/RELEASE_NOTES_0.3.83.md`: notas desta fatia (BCB OLINDA PIB Exportação de bens e serviços).
...
- `evidence/releases/0.3.83/`: evidências desta fatia.
