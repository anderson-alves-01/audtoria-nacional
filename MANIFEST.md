# Conteúdo do kit e da implementação 0.3.82
...
- `docs/delivery/RELEASE_NOTES_0.3.82.md`: notas desta fatia (BCB OLINDA PIB Despesa de consumo da administração pública).
...
- `evidence/releases/0.3.82/`: evidências desta fatia.
