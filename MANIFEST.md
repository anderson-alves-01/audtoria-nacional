# Conteúdo do kit e da implementação 0.3.89
...
- `docs/delivery/RELEASE_NOTES_0.3.89.md`: notas desta fatia (BCB OLINDA Expectativas mensais IPCA).
...
- `evidence/releases/0.3.89/`: evidências desta fatia.
