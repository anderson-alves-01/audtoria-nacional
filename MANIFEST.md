# Conteúdo do kit e da implementação 0.3.75
...
- `docs/delivery/RELEASE_NOTES_0.3.75.md`: notas desta fatia (BCB OLINDA Taxa de desocupação).
...
- `evidence/releases/0.3.75/`: evidências desta fatia.
