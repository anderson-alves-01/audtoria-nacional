# Conteúdo do kit e da implementação 0.3.59
...
- `docs/delivery/RELEASE_NOTES_0.3.59.md`: notas desta fatia (ES FRD/Compensação).
...
- `evidence/releases/0.3.59/`: evidências desta fatia.
