# Conteúdo do kit e da implementação 0.3.92
...
- `docs/delivery/RELEASE_NOTES_0.3.92.md`: notas desta fatia (BCB OLINDA Expectativas mensais IPA/IGP-DI/INPC).
...
- `evidence/releases/0.3.92/`: evidências desta fatia.
