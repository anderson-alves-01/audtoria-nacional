# Conteúdo do kit e da implementação 0.3.84
...
- `docs/delivery/RELEASE_NOTES_0.3.84.md`: notas desta fatia (BCB OLINDA PIB Importação de bens e serviços).
...
- `evidence/releases/0.3.84/`: evidências desta fatia.
