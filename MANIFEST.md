# Conteúdo do kit e da implementação 0.3.96
...
- `docs/delivery/RELEASE_NOTES_0.3.96.md`: notas desta fatia (BCB OLINDA ExpectativasMercadoSelic).
...
- `evidence/releases/0.3.96/`: evidências desta fatia.
