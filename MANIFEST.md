# Conteúdo do kit e da implementação 0.3.94
...
- `docs/delivery/RELEASE_NOTES_0.3.94.md`: notas desta fatia (BCB OLINDA trimestrais PIB setoriais).
...
- `evidence/releases/0.3.94/`: evidências desta fatia.
