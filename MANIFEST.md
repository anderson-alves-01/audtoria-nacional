# Conteúdo do kit e da implementação 0.3.63
...
- `docs/delivery/RELEASE_NOTES_0.3.63.md`: notas desta fatia (Tesouro FUNDEB COINT).
...
- `evidence/releases/0.3.63/`: evidências desta fatia.
