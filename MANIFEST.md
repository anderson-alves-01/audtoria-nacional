# Conteúdo do kit e da implementação 0.3.87
...
- `docs/delivery/RELEASE_NOTES_0.3.87.md`: notas desta fatia (BCB OLINDA IPC-Fipe/IPA-M/IPA-DI).
...
- `evidence/releases/0.3.87/`: evidências desta fatia.
