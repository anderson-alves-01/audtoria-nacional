# Conteúdo do kit e da implementação 0.3.85
...
- `docs/delivery/RELEASE_NOTES_0.3.85.md`: notas desta fatia (BCB OLINDA Produção industrial).
...
- `evidence/releases/0.3.85/`: evidências desta fatia.
