# Conteúdo do kit e da implementação 0.3.91
...
- `docs/delivery/RELEASE_NOTES_0.3.91.md`: notas desta fatia (BCB OLINDA Expectativas mensais IPCA componentes).
...
- `evidence/releases/0.3.91/`: evidências desta fatia.
