# Conteúdo do kit e da implementação 0.3.67
...
- `docs/delivery/RELEASE_NOTES_0.3.67.md`: notas desta fatia (BCB OLINDA Expectativas IPCA/Selic/Câmbio).
...
- `evidence/releases/0.3.67/`: evidências desta fatia.
