# Conteúdo do kit e da implementação 0.3.72
...
- `docs/delivery/RELEASE_NOTES_0.3.72.md`: notas desta fatia (BCB OLINDA Resultado + Conta corrente).
...
- `evidence/releases/0.3.72/`: evidências desta fatia.
