# Conteúdo do kit e da implementação 0.3.74
...
- `docs/delivery/RELEASE_NOTES_0.3.74.md`: notas desta fatia (BCB OLINDA Dívida bruta).
...
- `evidence/releases/0.3.74/`: evidências desta fatia.
