# Conteúdo do kit e da implementação 0.3.73
...
- `docs/delivery/RELEASE_NOTES_0.3.73.md`: notas desta fatia (BCB OLINDA Resultado nominal).
...
- `evidence/releases/0.3.73/`: evidências desta fatia.
