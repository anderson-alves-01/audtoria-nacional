# Conteúdo do kit e da implementação 0.3.64
...
- `docs/delivery/RELEASE_NOTES_0.3.64.md`: notas desta fatia (Tesouro LC 87/96 COINT).
...
- `evidence/releases/0.3.64/`: evidências desta fatia.
