# Conteúdo do kit e da implementação 0.3.76
...
- `docs/delivery/RELEASE_NOTES_0.3.76.md`: notas desta fatia (BCB OLINDA Investimento direto).
...
- `evidence/releases/0.3.76/`: evidências desta fatia.
