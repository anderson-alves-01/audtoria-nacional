# Conteúdo do kit e da implementação 0.3.62
...
- `docs/delivery/RELEASE_NOTES_0.3.62.md`: notas desta fatia (Tesouro FUNDEB complement).
...
- `evidence/releases/0.3.62/`: evidências desta fatia.
