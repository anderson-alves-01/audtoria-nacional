# Conteúdo do kit e da implementação 0.3.71
...
- `docs/delivery/RELEASE_NOTES_0.3.71.md`: notas desta fatia (BCB OLINDA Dívida + Balança Saldo).
...
- `evidence/releases/0.3.71/`: evidências desta fatia.
