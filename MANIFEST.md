# Conteúdo do kit e da implementação 0.3.80
...
- `docs/delivery/RELEASE_NOTES_0.3.80.md`: notas desta fatia (BCB OLINDA PIB Formação Bruta de Capital Fixo).
...
- `evidence/releases/0.3.80/`: evidências desta fatia.
