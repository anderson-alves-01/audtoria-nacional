# Conteúdo do kit e da implementação 0.3.60
...
- `docs/delivery/RELEASE_NOTES_0.3.60.md`: notas desta fatia (AC ICMS/FUNDEB Transparência).
...
- `evidence/releases/0.3.60/`: evidências desta fatia.
