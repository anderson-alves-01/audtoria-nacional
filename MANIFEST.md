# Conteúdo do kit e da implementação 0.3.66
...
- `docs/delivery/RELEASE_NOTES_0.3.66.md`: notas desta fatia (BCB OLINDA Expectativas IPCA).
...
- `evidence/releases/0.3.66/`: evidências desta fatia.
