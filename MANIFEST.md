# Conteúdo do kit e da implementação 0.3.69
...
- `docs/delivery/RELEASE_NOTES_0.3.69.md`: notas desta fatia (BCB OLINDA Expectativas IGP/INPC).
...
- `evidence/releases/0.3.69/`: evidências desta fatia.
