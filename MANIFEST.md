# Conteúdo do kit e da implementação 0.3.58
...
- `docs/delivery/RELEASE_NOTES_0.3.58.md`: notas desta fatia (AL/PR royalties estaduais).
...
- `evidence/releases/0.3.58/`: evidências desta fatia.
