# Conteúdo do kit e da implementação 0.3.61
...
- `docs/delivery/RELEASE_NOTES_0.3.61.md`: notas desta fatia (RS Compensação LC194).
...
- `evidence/releases/0.3.61/`: evidências desta fatia.
