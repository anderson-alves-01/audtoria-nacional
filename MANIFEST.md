# Conteúdo do kit e da implementação 0.3.97
...
- `docs/delivery/RELEASE_NOTES_0.3.97.md`: notas desta fatia (BCB OLINDA Inflacao12/24m).
...
- `evidence/releases/0.3.97/`: evidências desta fatia.
