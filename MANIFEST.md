# Conteúdo do kit e da implementação 0.3.88
...
- `docs/delivery/RELEASE_NOTES_0.3.88.md`: notas desta fatia (BCB OLINDA Balança Exportações/Importações).
...
- `evidence/releases/0.3.88/`: evidências desta fatia.
