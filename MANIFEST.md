# Conteúdo do kit e da implementação 0.3.79
...
- `docs/delivery/RELEASE_NOTES_0.3.79.md`: notas desta fatia (BCB OLINDA IPCA Bens industrializados).
...
- `evidence/releases/0.3.79/`: evidências desta fatia.
