# Conteúdo do kit e da implementação 0.3.68
...
- `docs/delivery/RELEASE_NOTES_0.3.68.md`: notas desta fatia (BCB OLINDA Expectativas PIB).
...
- `evidence/releases/0.3.68/`: evidências desta fatia.
