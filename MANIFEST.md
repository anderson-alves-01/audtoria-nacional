# Conteúdo do kit e da implementação 0.3.90
...
- `docs/delivery/RELEASE_NOTES_0.3.90.md`: notas desta fatia (BCB OLINDA Expectativas mensais IGP-M + Câmbio).
...
- `evidence/releases/0.3.90/`: evidências desta fatia.
