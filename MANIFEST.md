# Conteúdo do kit e da implementação 0.3.57
...
- `docs/delivery/RELEASE_NOTES_0.3.57.md`: notas desta fatia (MA/PR FPEX + MS IPI/CIDE).
...
- `evidence/releases/0.3.57/`: evidências desta fatia.
