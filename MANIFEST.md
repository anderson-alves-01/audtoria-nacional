# Conteúdo do kit e da implementação 0.3.70
...
- `docs/delivery/RELEASE_NOTES_0.3.70.md`: notas desta fatia (BCB OLINDA PIB Agropecuária/Indústria).
...
- `evidence/releases/0.3.70/`: evidências desta fatia.
